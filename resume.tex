...
\item Researches and developed a spectral unmixing algorithm with statistical confidence metrics for analysis of HSI data.
...
Developed C++ software to make a Raspberry Pi into a working light board for Concordia High School\textquotesingle s auditorium, allowing presets to be saved and for the lights to be controlled wirelessly.\\
\\{\bf R/C Plane Builds}\\
